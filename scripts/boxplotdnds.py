...
def main():
    ...
    humanFELfiles = (
        ...
        '%s/dnds/FEL/alignedseq/human_M1_FEL_report.csv' % os.getcwd(),
        '%s/dnds/FEL/alignedseq/human_NP_FEL_report.csv' % os.getcwd(),
        )
    swineFELfiles = (
        #'%s/dnds/FEL/swine_PA_FEL_report.csv' % os.getcwd(),
        '%s/dnds/FEL/alignedseq/swine_M1_FEL_report.csv' % os.getcwd(),
        '%s/dnds/FEL/alignedseq/swine_NP_FEL_report.csv' % os.getcwd(),
        )
    epitopefiles = (
    ...
    adjustedhumanFELfiles = (
       # '%s/dnds/FEL/human_PA_FEL_report_fix.csv' % os.getcwd(),
        '%s/dnds/FEL/alignedseq/human_M1_FEL_report_fix.csv' % os.getcwd(),
        '%s/dnds/FEL/alignedseq/human_NP_FEL_report_fix.csv' % os.getcwd(),
        )
    adjustedswineFELfiles = (
       # '%s/dnds/FEL/swine_PA_FEL_report_fix.csv' % os.getcwd(),
        '%s/dnds/FEL/alignedseq/swine_M1_FEL_report_fix.csv' % os.getcwd(),
        '%s/dnds/FEL/alignedseq/swine_NP_FEL_report_fix.csv' % os.getcwd(),
        )
    proportionsiteswithhighdndsplotoutfile = (
       # '%s/plots/dnds/PA_highdnds.pdf' % os.getcwd(),
        '%s/plots/dnds/alignedseq/M1_highdnds.pdf' % os.getcwd(),
        '%s/plots/dnds/alignedseq/NP_highdnds.pdf' % os.getcwd(),
        )
   ...
   # labels = ['human epitope','human nonepitope', 'swine epitope', 'swine nonepitope']
    ...
    labels = ['M1', 'NP']
    outfile = '%s/plots/dnds/alignedseqcombined_FEL_proportiondndsabove1.pdf' % os.getcwd()
   ...
   # print masterproteinproportion_nonepitope
    ...
    if plotallproteins:
        ...
        scatterplot(M1_epitope,NP_epitope,M1_nonepitope,NP_nonepitope,outfile)
