...
def main():
    ...
    for atype in analysistype:
        ...
        for epitopetype in epitopetypes:
            ...
            outputsummary = '%s/plots/%s/%s/randomdistributionsummary.csv' % (os.getcwd(), epitopetype, atype)
            ...
            for protein in proteins:
                ...
                plothistogram = False
                plotfile = '%s/plots/%s/%s/%sdistribution.pdf' % (os.getcwd(), epitopetype, atype,protein)
