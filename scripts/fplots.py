...
def scatterplot(data1,data2,data3,data4,data9,data10,data5,data6,data7,data8,data11,data12,plotfile):
...
def appenddata(data1,data2,data3,data4,data5,data6):
    master = []
    master.append(data1)
    master.append(data2)
    master.append(data3)
...
def appenddata2(data1,data2,data3):
    master = []
    master.append(data1)
    master.append(data2)
    #master.append(data3)
...
def summary(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,outputsummary):
    ...
    *outputsummary* summary of f statistic'''
    ...
    f.write(',M1 tree,M1 trunk,NP tree,NP trunk,HA tree,HA trunk\n')
    f.write('fhuman/fswine,%f,%f,%f,%f,%f,%f\n' %(p1,p2,p3,p4,p11,p12))
    f.write(',M1 human, M1 swine, NP human, NP swine, HA human, HA swine\n')
    f.write('ftrunk/ftree,%f,%f,%f,%f,%f,%f\n' %(p5,p6,p7,p8,p13,p14))
    f.write(',M1,NP,HA\n')
    f.write('fhuman/fswine,%f,%f,%f\n' %(p9,p10,p15))
    f.close()
...
def main():
    ...
    datafiles = (
        ...
        '%s/human/HA_H3/antibodytreerandomdistribution.csv' % (os.getcwd()),
        '%s/human/HA_H3/antibodytrunkrandomdistribution.csv' % (os.getcwd())
    )
    ...
    if readdata:
        ...
        HAhumantree,HAswinetree,HAactualhumantree,HAactualswinetree=  opencsvfile(datafiles[4])
        HAhumantrunk,HAswinetrunk,HAactualhumantrunk,HAactualswinetrunk=  opencsvfile(datafiles[5])

    scatter = True
    plotfile = '%s/plots/cd8/testscatter.pdf' % (os.getcwd())
    if scatter:
        print 'making scatterplot'
        splot = scatterplot(M1actualhumantree,M1actualswinetree,NPactualhumantree,NPactualswinetree,HAactualhumantree,HAactualswinetree,M1actualhumantrunk,M1actualswinetrunk,NPactualhumantrunk, NPactualswinetrunk,HAactualhumantrunk, HAactualswinetrunk,plotfile)
    ...
    if calchumanswinefratio:
        ...
        actualHAtree = actualdeltahumanswine(HAactualhumantree,HAactualswinetree)
        actualHAtrunk = actualdeltahumanswine(HAactualhumantrunk,HAactualswinetrunk)
        ...
        HAtree,pHAtree = ratio(HAhumantree,HAswinetree,actualHAtree)
        HAtrunk,pHAtrunk = ratio(HAhumantrunk,HAswinetrunk,actualHAtrunk)

    appendfratio = True
    if appendfratio:
        humanswinefratiodata = appenddata(M1trunk,M1tree,NPtrunk,NPtree,HAtrunk,HAtree)
        actualhumswinefractiodata = appenddata(actualM1trunk,actualM1tree,actualNPtrunk,actualNPtree,actualHAtrunk,actualHAtree)
    ...
    plotfile = '%s/plots/cd8/testratiofhumanswine.pdf' % (os.getcwd())
    yax = [-0.5, 6]
    ...
    plotfile = '%s/plots/cd8/testratiotrunktree.pdf' % (os.getcwd())
    xlabs = ['human','swine','human','swine']
    ...
    if plottrunktotree:
        ...
        actualHAhumantrunktotree= ratio2(HAactualhumantrunk,HAactualhumantree)
        actualHAswinetrunktotree= ratio2(HAactualswinetrunk,HAactualswinetree)
        ...
        HAhumantrunktotree,pHAhuman = ratio(HAhumantrunk,HAhumantree,actualHAhumantrunktotree)
        HAswinetrunktotree,pHAswine = ratio(HAswinetrunk,HAswinetree,actualHAswinetrunktotree)
        trunktreefratiodata = appenddata(M1humantrunktotree,M1swinetrunktotree,NPhumantrunktotree, NPswinetrunktotree,HAhumantrunktotree, HAswinetrunktotree)
        actualtrunktreefratiodata = appenddata(actualM1humantrunktotree,actualM1swinetrunktotree,actualNPhumantrunktotree, actualNPswinetrunktotree,actualHAhumantrunktotree, actualHAswinetrunktotree)
    ...
    plotfile = '%s/plots/cd8/testratiotrunktreehumanswine.pdf' % (os.getcwd())
    xlabs = ['M1','NP']
    xtitle = ''
    ...
    if plottrunktotreehumantoswine:
        ...
        actualHAtrunktotreehumantoswine = ratio2(actualHAhumantrunktotree,actualHAswinetrunktotree)
        ...
        HAtrunktotreehumantoswine,pHA = ratio(HAhumantrunktotree,HAswinetrunktotree,actualHAtrunktotreehumantoswine)
        trunktreehumanswinefratiodata = appenddata2(M1trunktotreehumantoswine,NPtrunktotreehumantoswine,HAtrunktotreehumantoswine)
        actualtrunktreehumanswinefratiodata = appenddata2(actualM1trunktotreehumantoswine,actualNPtrunktotreehumantoswine,actualHAtrunktotreehumantoswine)
    ...
    if writesummary:
        ...
        pvalsummary = summary(pM1tree,pM1trunk,pNPtree,pNPtrunk,pM1human,pM1swine,pNPhuman,pNPswine,pM1,pNP,pHAtree,pHAtrunk,pHAhuman,pHAswine,pHA,summarypvalues)
