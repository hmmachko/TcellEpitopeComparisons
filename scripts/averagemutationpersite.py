...
def main():
    ...
    humantreeoutfiles = (
                '%s/human/NP/humantreeavemutationpersite.csv'% os.getcwd(),
                '%s/human/PA/humantreeavemutationpersite.csv'% os.getcwd(),
                '%s/human/M1/humantreeavemutationpersite.csv'% os.getcwd(),
               

                )
    swinetreeoutfiles = (
                '%s/human/NP/swinetreeavemutationpersite.csv'% os.getcwd(),
                '%s/human/PA/swinetreeavemutationpersite.csv'% os.getcwd(),
                '%s/human/M1/swinetreeavemutationpersite.csv'% os.getcwd(),
                )

    humantrunkoutfiles = (
                '%s/human/NP/humantrunkavemutationpersite.csv'% os.getcwd(),
                '%s/human/PA/humantrunkavemutationpersite.csv'% os.getcwd(),
                '%s/human/M1/humantrunkavemutationpersite.csv'% os.getcwd(),
                )
    swinetrunkoutfiles = (
                '%s/human/NP/swinetrunkavemutationpersite.csv'% os.getcwd(),
                '%s/human/PA/swinetrunkavemutationpersite.csv'% os.getcwd(),
                '%s/human/M1/swinetrunkavemutationpersite.csv'% os.getcwd(),
                )
    ...
    for entry in align_datainput:
        ...
        if findnodeandlength:
            termnode, sequencelength = findlengthandterminalnode(entry[0])
        getnodedict = True
        if getnodedict:
            nodedict,humantermnode, swinetermnode = gettaxanamedict(entry[0],termnode)
        
        swapbranchandhistory = True
        if swapbranchandhistory:
            swap = swapbranchlengthandhistory(entry[0], nodedict)     
